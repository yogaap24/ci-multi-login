...
class Auth extends MY_Controller
{
    ...
    public function login()
    {
        ...
        if ($this->input->post('submit')) {
            ...
            $this->form_validation->set_rules('password', 'Password', 'trim|required|min_length[6]|max_length[22]');
	...
	public function check_register()
    {
      ...
      $this->form_validation->set_rules('email', 'Email', 'trim|required|min_length[6]|max_length[50]');
	...
	public function register_admin()
    {
      ...
      $this->template->load('authentication/layout/template','authentication/admin-register',$data);
	}
	...
	public function check_register_admin()
    {
      $site = $this->Konfigurasi_model->listing();
      $data = array(
          'title'     => 'Register Admin | '.$site['nama_website'],
          'favicon'   => $site['favicon'],
          'site'      => $site
      );
      $this->form_validation->set_rules('username', 'Username', 'trim|required|min_length[6]|max_length[50]');
